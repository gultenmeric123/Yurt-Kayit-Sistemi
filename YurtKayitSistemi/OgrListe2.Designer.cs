namespace YurtKayitSistemi
{
	partial class OgrListe2
	{
		...
		private void InitializeComponent()
		{
			...
			this.yurtKayıtDataSet14 = new YurtKayitSistemi.YurtKayıtDataSet14();
			this.ogrenciBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.ogrenciTableAdapter = new YurtKayitSistemi.YurtKayıtDataSet14TableAdapters.OgrenciTableAdapter();
			...
			this.ogrenciBindingSource.DataSource = this.yurtKayıtDataSet14;
			// 
			// ogrenciTableAdapter
			// 
			...
			this.Name = "OgrListe2";
			this.Text = "OgrListe2";
			this.Load += new System.EventHandler(this.OgrListe2_Load);
		...
		private YurtKayıtDataSet14TableAdapters.OgrenciTableAdapter ogrenciTableAdapter;
